...
def should_calculate_number_of_overlapping_points:
  ( [ test_input ] | day5::total_crossover_points(false) |
    t::assert_that("crossover points for test input"; t::is(5))
  );

def should_calculate_number_of_overlapping_points_with_diagonals:
  ( [ test_input ] | day5::total_crossover_points(true) |
    t::assert_that("crossover points for test input with diagonals"; t::is(12))
  );
