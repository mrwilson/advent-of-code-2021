...
def should_map_to_distances_from_each_point:
  [0,1,2] | day7::distances_from_points(day7::linear) | (t::assert_that("distances from points" ; t::is([
    [0,1,2], [1,0,1], [2,1,0]
  ])));

def should_map_to_cumulative_distances_from_each_point:
  [1,2,3] | day7::distances_from_points(day7::triangle) | (t::assert_that("cumulative distances from points" ; t::is([
    [0,1,3], [1,0,1], [3,1,0]
  ])));
...
def should_calculate_shortest_distance_from_points: (
  test_input
    | day7::parse_input
    | day7::shortest_distance_from_points(day7::linear)
...
def should_calculate_cumulative_shortest_distance_from_points: (
  test_input
    | day7::parse_input
    | day7::shortest_distance_from_points(day7::triangle)
